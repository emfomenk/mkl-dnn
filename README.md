...
Graphics. Support for other architectures like Arm\* 64-bit Architecture
...
oneDNN supports the platforms based on the following architectures:
...
On CPU based on Intel 64 or AMD64 architecture oneDNN detects instruction set
architecture (ISA) at runtime and uses just-in-time (JIT) code generation to
