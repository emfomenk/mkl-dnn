...
template <typename T, int ndims>
void set_data_handle(memory &m, cl::sycl::buffer<T, ndims> b);
template <typename T, int ndims>
void set_data_handle(memory &m, cl::sycl::buffer<T, ndims> b, stream &s);
template <typename T, int ndims = 1>
cl::sycl::buffer<T, ndims> get_sycl_buffer(const memory &m);
